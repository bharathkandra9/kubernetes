...
echo "================================"
echo ""
echo "IMPORTANT: It is HIGHLY RECOMMENDED to reboot the system now to ensure"
echo "all kernel modules, network configurations, and services are fully reseted."
echo ""
